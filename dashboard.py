...
ax.plot(monthly_spend_df["order_approved_at"], monthly_spend_df["total_spend"], marker='o', linewidth=2, color="#068DA9")
ax.set_title("Total Customer Spend per Month (2018)", loc="center", fontsize=20)
ax.set_xticks(monthly_spend_df["order_approved_at"])
